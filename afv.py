...
#ILCA-99M2 AF POINTS END
          ...
          if   (exif.get ('Focal Plane AF Points Used')) :
               if exif.get ('Focal Plane AF Points Used') != '(none)' :
                    ...
                    elif exif.get('Camera Model Name') in ('ILCE-6300','ILCE-6500','ILCA-99M2','ILCA-77M2','ILCE-9','DSC-RX10M4','DSC-RX100M5','ILCE-7RM3','ILCE-7M3','DSC-RX100M6','ILCE-6400','ILCE-6600','ILCE-6100','DSC-RX0', 'DSC-RX0M2', 'MODEL-NAME', 'DSC-RX100M7', 'ILCE-7RM4', 'ILCE-9M2','ZV-1','ZV-E10') :
                         foc = exif.get ('Focal Plane AF Points Used')
                         if int(foc) :
          ...
          if 'Focus Location' in exif:
            ...
            if exif.get('AF Area Mode') == 'Tracking' and exif.get('AF Tracking') == 'Lock On AF' and exif.get('Camera Model Name') in ('ILCE-6400','ILCE-6100','ILCE-6600','ILCE-9','ILCE-7RM4','ILCE-RX100M7', "ILCE-9M2",'ZV-1','ZV-E10'):
          ...
          if exif.get('AF Type') == '15-point':
               ...
               if exif.get('Camera Model Name') in ('ILCE-6300','ILCE-6500','ILCA-99M2','ILCA-77M2','ILCE-9','DSC-RX10M4','DSC-RX100M5','ILCE-7RM3','ILCE-7M3','DSC-RX100M6','ILCE-6400', 'ILCE-6100','ILCE-6600', 'DSC-RX0', 'DSC-RX0M2', 'MODEL-NAME', 'DSC-RX100M7', 'ILCE-7RM4', "ILCE-9M2",'ZV-1','ZV-E10') :
